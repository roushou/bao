...
use baobao_core::{ContextFieldInfo, FileRules, GeneratedFile, Overwrite, PoolConfigInfo};
...
fn generate_init_code(field: &ContextFieldInfo) -> String {
    match field.rust_type.as_str() {
        "sqlx::PgPool" | "sqlx::MySqlPool" => generate_sqlx_pool_init(field),
        "sqlx::SqlitePool" => generate_sqlite_init(field),
        "reqwest::Client" => "reqwest::Client::new()".to_string(),
        _ => "todo!()".to_string(),
    }
}
