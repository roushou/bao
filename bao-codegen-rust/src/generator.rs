...
impl<'a> Generator<'a> {
    ...
    fn generate_command_file(&self, name: &str, command: &Command, is_async: bool) -> String {
        ...
        let mut builder = FileBuilder::rust().add_import("clap", "Args");
        ...
        builder
            .with_code(|c| c.raw(&content))
            .render_rust_with_header("// Generated by Bao - DO NOT EDIT")
    }
    ...
    fn generate_subcommand_struct(
        ...
        builder = parent_struct.render(builder).blank();
        builder = commands_enum.render(builder).blank();
        builder = dispatch_impl.render(builder).blank();
        ...
        for (sub_name, sub_command) in &command.commands {
            ...
            if sub_command.has_subcommands() {
                ...
                builder = builder.raw(&self.generate_subcommand_struct(
                    &nested_path,
                    &sub_pascal,
                    sub_command,
                    is_async,
                ...
                builder = builder.raw(&self.generate_args_struct(&sub_pascal, sub_command));
            }
        }
